...
from dataset.imagenet_dataset import build_imagenet_for_vqvae
from engine import evaluate, train_one_epoch, calculate_codebook_usage
...
def main(args):
    ...
    # get dataset
    dataset_train = build_imagenet_for_vqvae(is_train=True, args=args)
    if args.disable_eval:
        dataset_val = None
    else:
        dataset_val = build_imagenet_for_vqvae(is_train=False, args=args)
